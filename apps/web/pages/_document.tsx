    ...
    return (
      <Html
        ...
        <Head nonce={nonce}>
          ...
          />
          <link rel="apple-touch-icon" sizes="180x180" href="/calendso/api/logo?type=apple-touch-icon" />
          <link rel="icon" type="image/png" sizes="32x32" href="/calendso/api/logo?type=favicon-32" />
          <link rel="icon" type="image/png" sizes="16x16" href="/calendso/api/logo?type=favicon-16" />
